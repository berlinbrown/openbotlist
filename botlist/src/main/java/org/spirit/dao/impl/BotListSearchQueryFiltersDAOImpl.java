...
public class BotListSearchQueryFiltersDAOImpl extends HibernateDaoSupport implements BotListSearchQueryFiltersDAO {
        ...
        return getHibernateTemplate().executeFind(new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException {
                Query query = session.createQuery(
                        "from org.spirit.bean.impl.BotListSearchQueryFilters topic order by topic.id desc");
