...
public class BotListContractManager {
    ...
    public static BotListCoreUsersContract getUserInfo(HttpServletRequest request) {
        ...
        BotListCoreUsersContract userInfo = (BotListCoreUsersContract) cur_session
    ...
    /**
     * Create the user contract object based on information from the core user and profile settings objects. Note: A
     * similar utility exists in the ruby modules, 'core_users.rb'
     *
     * @return
     */
    public static BotListCoreUsersContract createUserContract(BotListProfileSettingsDAO dao_profile,
            BotListCoreUsers user_bean) {
