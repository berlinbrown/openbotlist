...
/**
 * The user contract manager contains settings specific to a particular user. This user session object also is an
 * indicator on if the user is logged in or not. See the session key, BotListSessionManager.USER_INFO_OBJECT
 * (session.coreuser) for access. Also, see "web/users.rb"
 *
 * @author Berlin Brown
 */
