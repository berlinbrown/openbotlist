...
public class BotListFileUploadUtil implements BotListFileUploadType {
    ...
    public int uploadFiles(HttpServletRequest request) throws Exception {
        ...
        while (iter.hasNext()) {
            ...
            // when the FileItem instance is garbage collected, this method can be used to ensure that this is done at
            // an earlier time, thus preserving system resources.
            item.delete();
        }
    ...
    /**
     * @param fileUploadEnabled
     *            the fileUploadEnabled to set
     */
