...
public class BotListSessionManager {
    ...
    /**
     * Safe create a new session. This method will help manage where sessions are created. (same logic as:
     * #request.getSession() )
     */
    ...
    /**
     * Get the session even if it is empty. (same logic as: #request.getSession(false)
     */
    ...
    /**
     * Java, if user is logged in, return the user id. Return null if the user is not logged in.
     */
