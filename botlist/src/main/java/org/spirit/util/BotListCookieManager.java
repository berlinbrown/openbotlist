...
public class BotListCookieManager {
     ...
     * @return
     */
    public final static boolean deleteCookieParam(HttpServletRequest request, HttpServletResponse response,
            String cookieKey) {
     ...
     */
    public final static void setRememberMeCookieParams(HttpServletResponse response,
            BotListCoreUsersContract userContract) {
    ...
    /**
     * Access the system cookie user contract settings. If the cookie values are available, set the session user
     * contract.
     */
