...
public class KeywordProcessor {
    ...
    public final static String[][] FILTER_SET = { { "&#39;", "'" }, { "&quot;", "'" }, { "&amp;", "&" }, { "<b>", "" },
            { "</b>", "" }, { "<B>", "" }, { "</B>", "" }, { "<strong>", "" }, { "</strong>", "" }, { "<STRONG>", "" },
            { "</STRONG>", "" } };

    /**
     * When saving a keyword, process the input to filter invalid characters and downcase the string.
     *
     * @return
     */
    ...
    /**
     * Utility for filtering alpha [a-Z], etc text using regular expressions, used with queries to prevent sql injection
     * hacks.
     */
     ...
     * @return
     */
    public final static String tagViewKeywords(final String value, final String styleClass, final String urlPrefix,
            final String suffix) {
