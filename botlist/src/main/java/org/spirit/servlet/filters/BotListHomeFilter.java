...
public class BotListHomeFilter implements Filter {
    ...
    public void doFilter(ServletRequest request_, ServletResponse response_, FilterChain chain)
        ...
        /*
         * String newUserId = "anon" + BotListUniqueId.getUniqueId(); Cookie cookie = new Cookie
         * (BotListCookieManager.USER_ID, newUserId); cookieUserId = newUserId; boolean cookieSecureFlag = false;
         * cookie.setMaxAge(Integer.MAX_VALUE); cookie.setPath("/"); cookie.setSecure(cookieSecureFlag);
