...
public abstract class BotListExpressionBaseTag extends BodyTagSupport {
     ...
     * NullAttributeException if it does. The function <b>can</b> return null, however, if the expression itself is
     * null.
     */
    public static Object evalNotNull(String tagName, String attributeName, String expression, Class expectedType,
            Tag tag, PageContext pageContext) throws JspException {
        if (expression != null) {
