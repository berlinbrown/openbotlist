...
public class BotListDocFileMetadata extends BotListBeanBase implements Serializable {
    ...
    /**
     * @param docOriginalname
     *            the docOriginalname to set
     */
