 ...
 * @author Berlin Brown
 */
public abstract class BotListEntity extends BotListBeanBase implements Serializable {
    ...
    /**
     * Print the hostname, use the hostname field or create the hostname display from the main URL field.
     *
