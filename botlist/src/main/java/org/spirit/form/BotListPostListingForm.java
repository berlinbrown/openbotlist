 ...
 * @author Berlin Brown
 */
public class BotListPostListingForm extends BotListBaseForm implements BotListBaseCalcVerify {
    ...
    /**
     * @param uploadFilenameFirst
     *            the uploadFilenameFirst to set
     */
    ...
    /**
     * @param uploadFilenameSecond
     *            the uploadFilenameSecond to set
     */
