...
public class BotListCoreUsersValidator implements Validator {
    ...
    public void validate(Object obj, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "userEmail", "required", "* Please Enter a valid Email.");
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "userPassword", "required",
                "* Please Enter a valid Password.");
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "verifyPassword", "required",
                "* Please Enter a valid Password.");
        ...
        if ((form != null) && (form.getVerifyPassword() != null) && (form.getUserPassword() != null)) {
