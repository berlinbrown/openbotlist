...
public class BotListRemoteSyncValidator implements Validator {
    ...
    public void validate(Object obj, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "developerKey", "required", "* Invalid Remote Send.");
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "remoteData", "required", "* Invalid Remote Send.");
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "remoteSyncKey", "required", "* Invalid Remote Send.");
    }
