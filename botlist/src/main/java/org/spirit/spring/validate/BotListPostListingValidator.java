...
public class BotListPostListingValidator implements Validator {
    ...
    public void validate(Object obj, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "message", "required", "* Message Field is required.");
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "email", "required", "* Email Field is required.");
