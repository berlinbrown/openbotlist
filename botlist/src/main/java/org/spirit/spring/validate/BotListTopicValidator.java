...
public class BotListTopicValidator implements Validator {
    ...
    public void validate(Object obj, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "fullName", "required", "* A name is required.");
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "subject", "required", "* A topic subject is required.");
