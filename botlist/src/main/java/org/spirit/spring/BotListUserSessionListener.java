...
/**
 * When user sessions are created or destroyed, keep track of who is logged in as well as other information on the total
 * of active sessions. See the web.xml for web application configuration.
 *
 * @author bbrown
 */
