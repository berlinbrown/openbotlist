...
<head>
<title>Botlist - Source</title>

<META NAME="DESCRIPTION" CONTENT="Botlist - Source">
<META NAME="keywords" CONTENT="source code, open, about, contact, berlin, search, index, listing, bot, botlist, botlisting, bot's list, list, ads, advertising">
...
<h1 class="bot_titlelogo">Botverse - Source</h1>
				...
				<table cellspacing="0" cellpadding="20">
					<tr>
						<td style="background-color: #FEFEFE;">
			 				The source for the botlist application has been released under
			 				a BSD license.  Source code cleanups are expected in the future (9/9/2007).
			 		...
			 		<tr>
    					...
    					<p />
    					You can contact the developers at <a href="mailto:berlinDOTbrownATgmail.com">(berlin dot brown / gmail)</a>
			 			</td>
			 		</tr>
			 	</table>
			 	<%-- *** End Image Table *** --%>
